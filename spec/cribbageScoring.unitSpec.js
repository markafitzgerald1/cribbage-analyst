...
(function() {
    ...
    describe('pairsPoints method', function() {
        ...
        it('returns 0 for an empty array of cards', function() {
            expect(
                cribbageScoring.pairsPoints(lodash, jsCombinatoricsSpy, [])
            ).toEqual(0);
        });
        ...
        it(
            ...
            function() {
                ...
                cribbageScoring.pairsPoints(lodash, jsCombinatoricsSpy, cards);
        ...
        it('returns 0 for a known index and an unknown index', function() {
            expect(
                cribbageScoring.pairsPoints(
                    lodash,
                    jsCombinatorics,
                    cribbageCard.parseIndices('AX')
                )
            ).toEqual(0);
        });
    ...
    describe('pairsFifteensAndRunsPoints method', function() {
        it('is defined', function() {
            expect(cribbageScoring.pairsFifteensAndRunsPoints).toBeDefined();
        });
    });
})();
